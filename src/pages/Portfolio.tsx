        ...
        <section ref={heroRef} className="reveal container mx-auto px-6 py-20">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl">
              Crafting digital experiences that stand out in a crowded landscape.
        ...
        <section ref={gridRef} className="reveal container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8">
            {filteredProjects.map((project, index) => (
              ...
              >
                <Card className="overflow-hidden bg-card border-border hover:border-accent transition-all duration-500 h-full">
                  ...
                  <div className="p-8">
                    ...
                    <h3 className="text-3xl font-display font-bold mb-3 group-hover:text-accent transition-colors">
                      {project.title}
                    </h3>
