              ...
              <div>
                ...
                <div className="flex gap-3">
                  ...
                  <Link
                    ...
                    className="group p-4 glass-card hover:border-accent/50 transition-all duration-300"
                  >
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 group-hover:text-accent transition-colors">
